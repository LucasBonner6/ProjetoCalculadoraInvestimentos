...
function renderProgression(evt) {
  ...
  pieChartReference = new Chart(finalMoneyChart, {
    type: "pie",
    data: {
...
function resetCharts() {
  if (
    !isObjectEmpty(pieChartReference) &&
    !isObjectEmpty(progressionChartReference)
  ) {
    pieChartReference.destroy();
...
function validateInput(evt) {
  ...
  if (
    ...
    errorTextElement.innerHTML = "Insira um valor numérico e maior que zero"; // <p class="text-red-500">Insira um valor numérico e maior que zero</p>
